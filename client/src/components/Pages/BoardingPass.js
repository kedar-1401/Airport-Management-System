...
const BoardingPass = () => {
  ...
  useEffect(() => {
    Axios.get(`http://localhost:5000/api/auth/showPass/${id}`).then((resp) =>
      setData({ ...resp.data[0] })
    );
  }, []);
  return (
      ...
      <div className="box">
        ...
        <div className="ticket">
          ...
          <div className="content">
            ...
            <span className="jfk jfkslip">A01</span>
