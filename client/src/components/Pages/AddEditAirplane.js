...
const AddEditAirplane = () => {
  ...
  useEffect(() => {
    Axios
      .get(`http://localhost:5000/api/auth/airplanegetbyid/${id}`)
  ...
  const handleSubmit = (event) => {
    ...
    if (
      ...
      if(!id)
      {
        ...
        Axios
          .post("http://localhost:5000/api/auth/sendairplanedata", {
            airplane_id,
            max_seats,
          })
          .then((response) => {
        ...
        Axios
          .put(`http://localhost:5000/api/auth/airplanegetdata/${id}`, {
            airplane_id,
            max_seats,
          })
          .then((response) => {
